            ...
            <div class="actions-slider__inner">
                ...
                <div class="actions-slider__sldr js-actions-slider">
                    <div class="actions-slider__item">
                        <div class="actions__item"><a class="actions__item-img" href="#"
                                                      style="background-image: url('{{ asset('assets/images/action-img1.jpg') }}')"></a>
                            <div class="actions__item-tx">
                                <div class="actions__item-data">с 2 ноября по 4 апреля</div>
                                <a class="actions__item-title" href="#">Неделя черных суперцен</a>
                    ...
                    <div class="actions-slider__item">
                        <div class="actions__item"><a class="actions__item-img" href="#"
                                                      style="background-image: url('{{ asset('assets/images/action-img2.jpg') }}')"></a>
                            <div class="actions__item-tx">
                                <div class="actions__item-data">с 2 ноября по 4 апреля</div>
                                <a class="actions__item-title" href="#">Неделя черных суперцен</a>
                                <div class="actions__item-firm">ООО «Мир здоровья»</div>
                    ...
                    <div class="actions-slider__item">
                        <div class="actions__item"><a class="actions__item-img" href="#"
                                                      style="background-image: url('{{ asset('assets/images/action-img3.jpg') }}')"></a>
                            <div class="actions__item-tx">
                                <div class="actions__item-data">с 2 ноября по 4 апреля</div>
                                <a class="actions__item-title" href="#">Неделя черных суперцен</a>
                                <div class="actions__item-firm">ООО «Мир здоровья»</div>
                    ...
                    <div class="actions-slider__item">
                        <div class="actions__item"><a class="actions__item-img" href="#"
                                                      style="background-image: url('{{ asset('assets/images/action-img4.jpg') }}')"></a>
                            <div class="actions__item-tx">
                                <div class="actions__item-data">с 2 ноября по 4 апреля</div>
                                <a class="actions__item-title" href="#">Неделя черных суперцен</a>
                                <div class="actions__item-firm">ООО «Мир здоровья»</div>
                ...
                <div class="catalog__top">
                    <div class="filter">
                        ...
                        <div class="filter-bl">
                            ...
                            <div class="filter__btn-b"><a class="button button-primary" href="#">Показать 40 товаров</a><a
                                    class="button button-tx" href="#">Сбросить</a></div>
                        </div>
                    </div>
                ...
                <div class="catalog__list">
                    <div class="row">
                        <div class="col-lg-2-1 col-lg-3 col-md-4 col-sm-6">
                            <div class="catalog__item">
                                <div class="catalog__item-top"><a class="catalog__item-img" href="#"><img
                                            src="{{ asset('assets/images/catalog-img12.jpg') }}" alt=""></a>
                                ...
                                <div class="catalog__item-tx"><a class="catalog__item-title" href="#">Клубника отборная
                                        ~ 250 г</a>
                        ...
                        <div class="col-lg-2-1 col-lg-3 col-md-4 col-sm-6">
                            <div class="catalog__item">
                                <div class="catalog__item-top"><a class="catalog__item-img" href="#"><img
                                            src="{{ asset('assets/images/catalog-img13.jpg') }}" alt=""></a>
                                    <div class="catalog__item-fav">
                                        <svg>
                                            <use xlink:href="#like"></use>
                                        </svg>
                                ...
                                <div class="catalog__item-tx"><a class="catalog__item-title" href="#">Мандарины
                                        Абхазские ~ 500 гр.</a>
                        ...
                        <div class="col-lg-2-1 col-lg-3 col-md-4 col-sm-6">
                            <div class="catalog__item catalog__item-favorites">
                                <div class="catalog__item-top"><a class="catalog__item-img" href="#"><img
                                            src="{{ asset('assets/images/catalog-img14.jpg') }}" alt=""></a>
                                    <div class="catalog__item-fav">
                                        <svg>
                                            <use xlink:href="#like"></use>
                                        </svg>
                                ...
                                <div class="catalog__item-tx"><a class="catalog__item-title" href="#">Манго Кео Вьетнам
                                        ~ 350 г</a>
                                    <div class="catalog__item-numb">1 шт (125 г)</div>
                                    <div class="catalog__item-bottom">
                                        <div class="catalog__item-info">
                        ...
                        <div class="col-lg-2-1 col-lg-3 col-md-4 col-sm-6">
                            <div class="catalog__item">
                                <div class="catalog__item-top"><a class="catalog__item-img" href="#"><img
                                            src="{{ asset('assets/images/catalog-img15.jpg') }}" alt=""></a>
                                    <div class="catalog__item-fav">
                                        <svg>
                                            <use xlink:href="#like"></use>
                                        </svg>
                                ...
                                <div class="catalog__item-tx"><a class="catalog__item-title" href="#">Помидоры Узбекские
                                        сладкие ~ 500 г</a>
                                    <div class="catalog__item-numb">1 шт (125 г)</div>
                                    <div class="catalog__item-bottom">
                                        <div class="catalog__item-info">
                        ...
                        <div class="col-lg-2-1 col-lg-3 col-md-4 col-sm-6">
                            <div class="catalog__item">
                                <div class="catalog__item-top"><a class="catalog__item-img" href="#"><img
                                            src="{{ asset('assets/images/catalog-img16.jpg') }}" alt=""></a>
                                    <div class="catalog__item-fav">
                                        <svg>
                                            <use xlink:href="#like"></use>
                                        </svg>
                                ...
                                <div class="catalog__item-tx"><a class="catalog__item-title" href="#">Авокадо Хасс ~ 2
                                        шт. в упаковке 350 г</a>
                                    <div class="catalog__item-numb">1 шт (125 г)</div>
                                    <div class="catalog__item-bottom">
                                        <div class="catalog__item-info">
                                            <div class="catalog__item-price">
                        ...
                        <ul class="pagination">
                            <li class="page-item prev"><a class="page-link" href="#"><span
                                        class="tx">Предыдущая</span><span class="arrow"><img
                                            src="{{ asset('assets/images/svg/arrow2.svg') }}" alt=""></span></a></li>
