                ...
                <div class="row">
                    ...
                    <div class="col-lg-2-1 col-lg-3 col-md-4 col-sm-6">
                        <div class="catalog__item">
                            <div class="catalog__item-top"><a class="catalog__item-img" href="{{ route('product', $product->id) }}">
                            ...
                            <div class="catalog__item-tx"><a class="catalog__item-title" href="{{ route('product', $product->id) }}">{{ $product->title }}</a>
                                <div class="catalog__item-numb">{{ $product->weight }}</div>
                                <div class="catalog__item-bottom">
                                    <div class="catalog__item-info">
                                        <div class="catalog__item-price">
                                            <div class="catalog__item-price-old"> руб</div>
